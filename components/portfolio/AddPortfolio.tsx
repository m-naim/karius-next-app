        ...
        <div className=" md:w-auto shadow-xl relative flex gap-6 flex-col  justify-center items-center bg-white py-12 px-12 rounded-md bg-dark ">
            <div className="flex gap-4 flex-col ">
                <div className='flex gap-8 items-center justify-between'>
                    <p className="text-xl font-semibold leading-7 lg:leading-9 text-gray-800" >Créer un portefeuille</p>
                    <div className="-mr-2">
                        <button type="button"
                            onClick={hide}
                ...
                <div>
                    <h1 role="main" className="text-lg font-semibold leading-7 lg:leading-9 text-gray-800">Nom du portefeuille</h1>
                ...
                <div>
                    <h1 role="main" className="text-lg font-semibold leading-7 lg:leading-9 text-gray-800">Valeur initial</h1>
