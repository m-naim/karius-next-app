...
import Autocomplite from '../layout/Autocomplite';
        ...
        <div className="w-full max-w-xl shadow-xl relative flex gap-6 flex-col  justify-center items-center bg-white py-8 px-12 rounded-md bg-dark ">
            <div className="flex gap-4 flex-col w-full">
                <div className='flex gap-8 items-center justify-between'>
                    <p className="text-xl font-semibold leading-7 lg:leading-9 text-gray-800" >Ajouter une transaction</p>
                    <div className="-mr-2">
                        <button type="button"
                            onClick={hide}
                ...
                <div>
                    <h3 role="main" className="text-lg font-semibold leading-7 lg:leading-9 text-gray-800">Action</h3>
                    <Autocomplite value={ticker} setValue={setTicker} fetchData={fetchData} />
                </div>

                <div>
                    <h3 role="main" className="text-lg font-semibold leading-7 lg:leading-9 text-gray-800">Date</h3>
                    <input className='input-primary' type='date' value={date} onChange={(e) =>{ setDate(e.currentTarget.value);}} />
                </div>
                <div>
                    <h3 role="main" className="text-lg font-semibold leading-7 lg:leading-9 text-gray-800">Prix</h3>
                    <input className='input-primary' type='number' step={0.01} value={prix} onChange={(e) => setPrix(e.currentTarget.value)} />
                </div>
                <div>
                    <h3 role="main" className="text-lg font-semibold leading-7 lg:leading-9 text-gray-800">Quantité</h3>
