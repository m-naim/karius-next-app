...
function AddTransaction({ hide, addClick, symbol }) {
    ...
    return (
        <div className="w-full max-w-xl shadow-xl relative flex gap-6 flex-col  justify-center items-center py-8 px-12 rounded-md bg-dark ">
            <div className="flex gap-4 flex-col w-full">
                ...
                <div>
                    <h3 role="main" className="text-lg font-semibold leading-7 lg:leading-9 ">Action</h3>
                    <Autocomplite value={ticker} setValue={setTicker} fetchData={fetchData} />
                </div>

                <div>
                    <h3 role="main" className="text-lg font-semibold leading-7 lg:leading-9 ">Date</h3>
                    <input className='input-primary' type='date' value={date} onChange={(e) =>{ setDate(e.currentTarget.value);}} />
                </div>
                <div>
                    <h3 role="main" className="text-lg font-semibold leading-7 lg:leading-9 ">Prix</h3>
                    <input className='input-primary' type='number' step={0.01} value={prix} onChange={(e) => setPrix(e.currentTarget.value)} />
                </div>
                <div>
                    <h3 role="main" className="text-lg font-semibold leading-7 lg:leading-9 ">Quantité</h3>
